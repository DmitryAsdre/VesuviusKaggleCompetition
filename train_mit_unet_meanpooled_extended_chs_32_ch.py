...
class CFG:
    ...
    PATH_TO_SAVE = '../models/'
    exp_name = 'mit_b2_meanpooled_extended_chns'
...
def train_on_fold(valid_img, writer):    
    ...
    model =UnetMeanPooled(encoder_name=CFG.backbone_name, decoder_attention_type=CFG.decoder_attention_type, extend_chs=True, 
