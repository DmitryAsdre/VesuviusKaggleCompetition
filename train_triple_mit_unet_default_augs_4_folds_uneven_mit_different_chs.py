...
class CFG:
    ...
    PATH_TO_SAVE = '../models/'
    exp_name = 'triple_mit_b1_b2_9_slices_from_the_middle_default_augmentations_4_folds_uneven_different_chans'
    chans_idxs = np.array([25, 26, 27, 28, 29, 30, 31, 32, 33]) + 1
