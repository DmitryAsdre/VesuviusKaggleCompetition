...
class CFG:
    ...
    exp_name = 'triple_mit_l1_9_slices_from_the_middle_default_augmentations_4_folds_pretrained_decoder_24-32'
    chans_idxs = [24, 25, 26, 27, 28, 29, 30, 31, 32]
