...
class CFG:
    ...
    exp_name = 'triple_mit_b1_9_slices_from_the_middle_default_augmentations_4_folds_uneven_label_noise_shuffle_chans_retrain_mit_b1'
...
def load_freeze_model(path_to_pth):
    ...
    optimizer = AdamW(model.conv.parameters(), lr=CFG.lr)
...
def train_on_fold(valid_img, writer, path_to_pth):    
    ...
    model, optimizer, scheduler = load_freeze_model(path_to_pth)
