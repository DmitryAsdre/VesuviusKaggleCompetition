...
class CFG:
    ...
    PATH_TO_SAVE = '../models/'
    exp_name = 'efficientnet_b3_meanpooled'
...
def train_on_fold(valid_img, writer):    
    ...
    model = MAnetMeanPooled(encoder_name=CFG.backbone_name, crop_stride=CFG.crop_stride, encoder_weights=CFG.encoder_weights)
